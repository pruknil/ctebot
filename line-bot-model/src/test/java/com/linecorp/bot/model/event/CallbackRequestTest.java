...
public class CallbackRequestTest {
  ...
  public void textTextGroup() throws IOException {
    parse("callback/text-group.json", callbackRequest -> {
      ...
      assertThat(event.getSource().getUserId()).isNull();
  ...
  public void testImage() throws IOException {
    parse("callback/image.json", callbackRequest -> {
      ...
      assertThat(image.getContentProvider()).isEqualTo(new ContentProvider("external",
          "https://example.com/original.jpg", "https://example.com/preview.jpg"));
    });
  }
  ...
  public void testFile() throws IOException {
    parse("callback/file.json", callbackRequest -> {
      ...
      if (message instanceof FileMessageContent) {
        assertThat(((FileMessageContent) message).getFileName()).isEqualTo("sample.pdf");
        assertThat(((FileMessageContent) message).getFileSize()).isEqualTo(22016);
      }
    });
  }
  ...
  public void testBeacon() throws IOException {
    parse("callback/beacon.json", callbackRequest -> {
      ...
      assertThat(beaconEvent.getBeacon().getHwid()).isEqualTo("374591320");
      assertThat(beaconEvent.getBeacon().getType()).isEqualTo("enter");
      assertThat(beaconEvent.getBeacon().getDeviceMessage()).isNull();
      assertThat(beaconEvent.getBeacon().getDeviceMessageAsHex()).isNull();
    });
  }
  ...
  public void testBeaconWithDeviceMessage() throws IOException {
    parse("callback/beacon_with_dm.json", callbackRequest -> {
      ...
      assertThat(beaconEvent.getSource()).isInstanceOf(UserSource.class);
      assertThat(beaconEvent.getSource().getUserId()).isEqualTo("U012345678901234567890123456789ab");
      assertThat(beaconEvent.getTimestamp()).isEqualTo(Instant.parse("2017-04-24T00:00:00Z"));
      assertThat(beaconEvent.getBeacon().getHwid()).isEqualTo("374591320");
      assertThat(beaconEvent.getBeacon().getType()).isEqualTo("enter");
      assertThat(beaconEvent.getBeacon().getDeviceMessage()).containsExactly(0x12, 0x34, 0x56, 0x78, 0x90, 0xab,
          0xcd, 0xef);
      assertThat(beaconEvent.getBeacon().getDeviceMessageAsHex()).isEqualTo("1234567890abcdef");
    });
  }
  ...
  public void testAccountLink() throws IOException {
    parse("callback/account_link.json", callbackRequest -> {
      ...
      assertThat(accountLinkEvent.getLink().getResult()).isEqualTo(LinkContent.Result.OK);
      assertThat(accountLinkEvent.getLink().getNonce()).isEqualTo("xxxxxxxxxxxxxxx");
    });
  }
  ...
  public void testLineThingsLink() throws IOException {
    parse("callback/line-things-link.json", callbackRequest -> {
      ...
      assertThat(thingsEvent.getThings().getDeviceId()).isEqualTo("t016560bc3fb1e42b9fe9293ca6e2db71");
      assertThat(thingsEvent.getThings().getType()).isEqualTo(ThingsContent.ThingsType.LINK);
    });
  }
  ...
  public void testLineThingsUnlink() throws IOException {
    parse("callback/line-things-unlink.json", callbackRequest -> {
      ...
      ThingsEvent thingsEvent = (ThingsEvent) event;
      assertThat(thingsEvent.getThings().getDeviceId()).isEqualTo("t016560bc3fb1e42b9fe9293ca6e2db71");
      assertThat(thingsEvent.getThings().getType()).isEqualTo(ThingsContent.ThingsType.UNLINK);
    });
  }
  ...
  public void testMemberJoined() throws IOException {
    parse("callback/member_joined.json", callbackRequest -> {
      ...
      String uids = memberJoinedEvent.getJoined().getMembers().stream().map(Source::getUserId)
  ...
  public void testMemberLeft() throws IOException {
    parse("callback/member_left.json", callbackRequest -> {
      ...
      String uids = memberLeftEvent.getLeft().getMembers().stream().map(Source::getUserId)
          .collect(Collectors.joining(","));
      assertThat(uids).isEqualTo("U111111");
    });
  }
  ...
  public void testUnknown() throws IOException {
    parse("callback/unknown.json", callbackRequest -> {
      ...
      assertThat(event1.getSource()).isInstanceOf(UserSource.class);
      assertThat(event1.getSource().getUserId()).isEqualTo("U012345678901234567890123456789ab");
      assertThat(event1.getTimestamp()).isEqualTo(Instant.parse("2016-05-07T13:57:59.859Z"));
      assertThat(((UnknownEvent) event1).getType()).isEqualTo("greatNewFeature");
